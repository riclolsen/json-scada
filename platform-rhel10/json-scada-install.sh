...
#sudo dnf -y install gtkmm30-devel 
#wget --inet4-only https://dl.rockylinux.org/pub/rocky/10/devel/$(arch)/os/Packages/p/potrace-devel-1.16-7.el10.$(arch).rpm
#sudo dnf -y install ./potrace-devel-1.16-7.el10.$(arch).rpm
