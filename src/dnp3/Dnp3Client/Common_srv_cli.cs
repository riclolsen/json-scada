...
namespace Dnp3Driver
{
    partial class MainClass
    {
        ...
        public static string JsonConfigFilePathAlt = @"~/json-scada/conf/json-scada.json";
        ...
        {        
            ...
            public BsonValue valueBSON;
            public int cot;
            public DateTime serverTimestamp;
            public bool hasSourceTimestamp;
            public DateTime sourceTimestamp;
            public TimestampQuality timeStampQuality;
            public bool qOnline;
            public bool qRestart;
            public bool qCommLost;
            public bool qRemoteForced;
            public bool qLocalForced;
            public bool qOverrange;
            public bool qRollover;
            public bool qDiscontinuity;
            public bool qReferenceError;
            public bool qTransient;
            public int conn_number;
        }

        // acquired values queues (to be updated in mongodb realtime data collection)
        public static ConcurrentQueue<DNP3_Value>
