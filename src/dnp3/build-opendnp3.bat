...
cmake -DDNP3_DEMO=ON -DDNP3_TLS=ON -DDNP3_DOTNET=ON -DOPENSSL_ROOT_DIR="C:\Program Files\OpenSSL-Win64" -DOPENSSL_USE_STATIC_LIBS=TRUE -DOPENSSL_MSVC_STATIC_RT=TRUE ..
