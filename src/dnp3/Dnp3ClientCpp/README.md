...
This DNP3 client driver is programmed in C++ and depends on the OpenDNP3 library.
...
- _**autoCreateTags**_ [Boolean] - Allows to auto-create tags for a connection. Use false here to disable auto-create tags. **Mandatory parameter**.
