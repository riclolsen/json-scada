    ...
    partial class MainClass
    {
        ...
        )
        {
            ...
            { // has time tag, so change ASDU if necessary to embed a timetag                
                ...
                maptowithcp56time.Add(TypeID.M_ME_NA_1, TypeID.M_ME_TB_1);
                maptowithcp56time.Add(TypeID.M_ME_NB_1, TypeID.M_ME_TB_1);
                maptowithcp56time.Add(TypeID.M_ME_NC_1, TypeID.M_ME_TB_1);
