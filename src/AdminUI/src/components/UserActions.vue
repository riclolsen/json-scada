    ...
    <template v-slot:top>
      <v-toolbar flat class="d-print-none">
        ...
        <v-text-field
          ...
          v-on:keyup.enter="fetchUserActions"
          v-model="searchUsername"
          :label="t('admin.userActions.searchUsername')"
          hide-details
        ></v-text-field>
        <v-divider class="mx-4" inset vertical></v-divider>
        <v-text-field
          ...
          :label="t('admin.userActions.searchAction')"
          hide-details
        ></v-text-field>
        <v-divider class="mx-4" inset vertical></v-divider>
        <v-menu
        ...
        >
          <template #activator="{ props }">
            <v-text-field
              ...
              :label="t('admin.userActions.searchDateRange')"
  ...
  const fetchUserActions = async () => {
    ...
    try {
      ...
      userActions.value = json.userActions.map((action) => ({
        ...
        localTime: action.timeTag
          ? new Date(action.timeTag).toLocaleString()
          : '',
      }))
