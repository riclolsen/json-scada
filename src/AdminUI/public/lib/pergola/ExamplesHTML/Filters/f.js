...
var doc = pergola.doc,
		filters = [
  {name : "noise() – Rosewood", uri : pergola.filter.noise({baseFrequency : ".1 0"})},
  ...
  {name : "noise() – Stone", uri : pergola.filter.noise({baseFrequency : ".84 .85", tableValues : {R : ".45 .1", G : ".5 .12", B : ".5 .12"}})},
...
$C({
    ...
    fill : "white",
    stroke : "black",
    filter : f["dropShadow"]({x : -.5, y : -.5, stdDeviation : 3, dx : 4.5, dy : 4.5, "flood-color" : "#103058", "flood-opacity" : .6}),
    appendTo : doc
  });
...
$C({
    ...
    fill : "white",
    stroke : "black",
    filter : f["dropShadow"]({stdDeviation : 2, dx : 2, dy : 2, "flood-opacity" : 1}),
    appendTo : doc
  });
*/