...
/* 
 * the populating function below is assigned to the contains property.
 * Window contents are appended to the doc.transformable container (<g>).
 * Elements appended to any other container/layer of the window
