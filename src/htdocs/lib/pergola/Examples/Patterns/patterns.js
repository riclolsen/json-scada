...
var g = $C({element : "g", transform : "translate(20 40)", appendTo : pergola.user});
...
// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "catseye", appendTo : g});
...
g = $C({element : "g", transform : "translate(140 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "pirelli", appendTo : g});
...
g = $C({element : "g", transform : "translate(260 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "line", appendTo : g});
...
g = $C({element : "g", transform : "translate(380 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "grid", appendTo : g});
...
// Legend
$C({element : "text", y : 354, fill : "#A0A0A0", textNode : "bar", appendTo : g});
...
g = $C({element : "g", transform : "translate(500 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "grille", appendTo : g});
...
// Legend
$C({element : "text", y : 476, fill : "#A0A0A0", textNode : "pied_de_poule", appendTo : g});
...
// Legend
$C({element : "text", y : 594, fill : "#A0A0A0", textNode : "pied_de_poule1", appendTo : g});
...
g = $C({element : "g", transform : "translate(620 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "checkers", appendTo : g});
...
g = $C({element : "g", transform : "translate(740 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "dot", appendTo : g});
...
g = $C({element : "g", transform : "translate(860 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "hive", appendTo : g});
...
$C({
  ...
  width : 90,
  height : 90,
  fill : pergola.pattern.hive({colors : ["white", "silver"], transform : "scale(.25) rotate(90)"}),
  appendTo : g
});
*/
...
g = $C({element : "g", transform : "translate(980 40)", appendTo : pergola.user});

// Legend
$C({element : "text", y : -6, fill : "#A0A0A0", textNode : "ring", appendTo : g});
...
$C({
  ...
  width : 90,
  height : 90,
  fill : pergola.pattern.ring({colors : ["none", "navy", "darkred"], spacing : 16, size : 20}),
  appendTo : g
});
