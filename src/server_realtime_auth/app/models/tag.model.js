...
const Tag = mongoose.model(
  ...
  new mongoose.Schema({
    ...
    protocolSourcePublishingInterval: { type: Double, default: 5.0 },
    protocolSourceSamplingInterval: { type: Double, default: 5.0 },
    protocolSourceQueueSize: { type: Double, default: 5.0 },
    protocolSourceDiscardOldest: { type: Boolean, default: true },
