...
namespace IEC61850_Client
{
    partial class MainClass
    {
        ...
        public static ConcurrentQueue<IECValue>
            IECDataQueue = new ConcurrentQueue<IECValue>(); // acquired values queue (to be updated in mongodb realtime data collection)
        public static List<Iec61850Connection> Iec61850Connections = new List<Iec61850Connection>();
        ...
        public class
        Iec61850Connection // protocol connection to RTU
        {
            ...
            public Double class0ScanInterval { get; set; }
            
            [BsonDefaultValue(true)]
            public bool useBrcb { get; set; } // use buffered reports (parameter not in admin UI)
            [BsonDefaultValue(true)]
            public bool useUrcb { get; set; } // use unbuffered reports (parameter not in admin UI)
            [BsonDefaultValue(false)]
            public bool browse { get; set; } // browse all IEC61850 tree (parameter not in admin UI)

            public Dictionary<string, byte[]> lastReportIds { get; set; } = new Dictionary<string, byte[]>(); // list of last seen reports to be logged to/read from disk
            public Dictionary<string, Iec61850Entry> entries = new Dictionary<string, Iec61850Entry>(); // list of desired entries
            public Double LastNewKeyCreated;
            public SortedSet<string> InsertedTags = new SortedSet<string>();
            public IedConnection connection;
            public List<string> brcb = new List<string>(); // list of buffered reports
            public List<string> urcb = new List<string>(); // list of unbuffered reports
            public List<string> datasets = new List<string>(); // list of datasets
            public int brcbCount = 0; // count of receive buffered reports
            public Queue<Iec61850Control> ControlQueue = new Queue<Iec61850Control>(); // controls received queued
        }
        [BsonIgnoreExtraElements]
