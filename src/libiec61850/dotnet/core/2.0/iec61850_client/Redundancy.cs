                    ...
                    do
                    {
                        ...
                        foreach (protocolDriverInstancesClass inst in instances)
                        {
                            ...
                            if (Active)
                            {
                                ...
                                foreach (Iec61850Connection srv in Iec61850Connections)
                                {
                                    ...
                                    {                                        
                                        ...
                                        var upd =
                                            ...
                                            {"lastReportIds", BsonDocument.Create(srv.lastReportIds)},
                                            {"stats", new BsonDocument{
                                                { "nodeName", JSConfig.nodeName },
                                                { "timeTag", BsonDateTime.Create(DateTime.Now) },
                                                // { "isConnected", BsonBoolean.Create(srv.connection.GetState()==IedConnectionState.IED_STATE_CONNECTED) },
                                                }},
                                                });
