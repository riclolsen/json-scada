...
const i18n = {
    ...
    tagSearchTag: "Search Tag",
    tagSearchDescription: "Search Description",
    tagConfirmErase: "Confirm delete tag?",
    tagEraseId: "Tag _id",
    tagEraseName: "Tag name",
    tagEraseCancel: "Cancel",
    tagEraseExecute: "Delete",
    tagNewTag: "New Tag",
    tagEditTag: "Edit Tag",
    tagEditId: "Tag _id (numeric point key)",
    tagEditName: "Tag name (string key)",
    tagEditDescription: "Description",
    tagEditGroup1: "Group 1 (e.g.Installation/Plant)",
    tagEditGroup2: "Group 2 (e.g.Area/Bay)",
    tagEditGroup3: "Group 3 (e.g.Equipment/Device)",
    tagEditOrigin: "Origin",
    tagEditType: "Type",
    tagEditStateTextTrue: "Text for state true",
    tagEditStateTextFalse: "Text for state false",
    tagEditEventTextTrue: "Text for event true",
    tagEditEventTextFalse: "Text for event false",
    tagEditUnit: "Unit",
    tagEditCommandOfSupervised: "Command point of supervised (use zero for none)",
    tagEditSupervisedOfCommand: "Supervised point of command (use zero for none)",
    tagEditInvalidDetectTimeout: "Invalid detect timeout (seconds)",
    tagEditProtocolSourceConnectionNumber: "Protocol source: connection number",
    tagEditProtocolSourceASDU: "Protocol source: ASDU type",
    tagEditProtocolSourceCommonAddress: "Protocol source: common address",
    tagEditProtocolSourceObjectAddress: "Protocol source: object address",
    tagEditProtocolSourceCommandDuration: "Protocol source: command duration",
    tagEditProtocolSourceCommandUseSBO: "Use SBO: ",
    tagEditProtocolSourceCommandUseSBOTrue: "True",
    tagEditProtocolSourceCommandUseSBOFalse: "False",
    tagEditKconv1: "Conversion factor: multiplier (kconv1)",
    tagEditKconv2: "Conversion factor: adder (kconv2)",
    tagEditIsEvent: "Is event: ",
    tagEditIsEventTrue: "True",
